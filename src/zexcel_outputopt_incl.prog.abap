...
SELECTION-SCREEN BEGIN OF BLOCK bl1 WITH FRAME TITLE txt_bl1.
  PARAMETERS: rb_down NO-DISPLAY.       "RADIOBUTTON GROUP rb1 USER-COMMAND space.

  PARAMETERS: rb_back NO-DISPLAY.       "RADIOBUTTON GROUP rb1.

  PARAMETERS: rb_show NO-DISPLAY.       "RADIOBUTTON GROUP rb1 DEFAULT 'X' .

  PARAMETERS: rb_send NO-DISPLAY.       "RADIOBUTTON GROUP rb1.

  PARAMETERS: p_path  TYPE string LOWER CASE MODIF ID pat.
  PARAMETERS: p_email TYPE string NO-DISPLAY.   "LOWER CASE MODIF ID ema OBLIGATORY DEFAULT 'insert_your_emailadress@here'
